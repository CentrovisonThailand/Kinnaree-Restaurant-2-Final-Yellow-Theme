  ...
  useEffect(() => {
    ...
    function initViewer() {
      ...
      const selectedPanorama = isMobileOrTablet
        ? '/image/Kinnaree-Restaurant-2-Final-Yellow-Theme-4096x2048.jpg' // รูป 4K (สำหรับมือถือ/iPad)
        : '/image/Kinnaree-Restaurant-2-Final-Yellow-Theme.jpg';          // รูป 16K (สำหรับคอมพิวเตอร์)
